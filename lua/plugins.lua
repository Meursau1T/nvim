...
require("lazy").setup({
  ...
  },
  {
    ...
    keys = {
      ...
      { "<leader>fgs", function() Snacks.picker.git_diff() end, desc = "Git diff" },
      { "<leader>fb", function() Snacks.picker.buffers() end, desc = "Git diff" },
      { "<leader>fl", function() Snacks.picker.files() end, desc = "Git diff" },
      { "<leader>fl", function() Snacks.picker.grep() end, desc = "Git diff" },
      { "<leader>fk", function() Snacks.picker.grep_word() end, desc = "Git diff" },
      { "<leader>fe", function() Snacks.explorer() end, desc = "Git diff" },
